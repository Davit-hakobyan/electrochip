            ...
            <div  className='servis_text' >
               ...
               <div  className='slid' >
                  <div  className='but1' style={{display:none?'block':'none'}} onClick={f} >
                    <svg  id='svgheder' xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-chevron-left" viewBox="0 0 16 16">
                  ...
                  <div  onClick={f1}    className='but' style={{display:none1?'block':'none'}} >
                    <svg  id='svgheder' xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-chevron-right" viewBox="0 0 16 16">
